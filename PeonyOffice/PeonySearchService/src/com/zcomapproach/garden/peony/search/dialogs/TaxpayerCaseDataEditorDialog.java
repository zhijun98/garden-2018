...
import com.zcomapproach.garden.peony.search.controllers.TaxpayerCaseDataEditorController;
 ...
 * @author zhijun98
 */
public class TaxpayerCaseDataEditorDialog extends PeonyFaceDialog{
    ...
    public TaxpayerCaseDataEditorDialog(Frame parent, boolean modal) {
        super(parent, modal);
    }
     ...
     */
    public void launchTaxpayerCaseDataEditorDialog(TaxpayerCaseStatusCacheResult targetTaxpayerCaseStatusCacheResult, TaxpayerCaseStatusReportColumns targetTaxpayerCaseStatusColumnType)
    {
    ...
    protected PeonyFaceController createPeonyFaceController() {
        if (getPeonyFaceController() == null){
            PeonyFaceController aPeonyFaceController = new TaxpayerCaseDataEditorController(targetTaxpayerCaseStatusCacheResult, targetTaxpayerCaseStatusColumnType);
