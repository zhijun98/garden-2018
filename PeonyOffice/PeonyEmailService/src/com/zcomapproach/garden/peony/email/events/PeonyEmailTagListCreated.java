 ...
 * @author zhijun98
 */
public class PeonyEmailTagListCreated extends PeonyFaceEvent {
    private final PeonyEmailTagList peonyEmailTagList;
    private final List<TreeItem<PeonyEmailTreeItemData>> selectedEmailTreeItems;

    public PeonyEmailTagListCreated(PeonyEmailTagList peonyEmailTagList, List<TreeItem<PeonyEmailTreeItemData>> selectedEmailTreeItems) {
        this.peonyEmailTagList = peonyEmailTagList;
        this.selectedEmailTreeItems = selectedEmailTreeItems;
    }

    public PeonyEmailTagList getPeonyEmailTagList() {
        return peonyEmailTagList;
    }
