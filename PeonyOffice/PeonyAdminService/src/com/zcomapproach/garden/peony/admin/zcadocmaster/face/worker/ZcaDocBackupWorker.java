...
import com.zcomapproach.garden.peony.admin.zcadocmaster.events.ZcaDocBackupWorkerEvent;
import com.zcomapproach.garden.util.nio.NioPathTreeSummary;
import com.zcomapproach.garden.util.nio.ZNioUtilities;
...
class ZcaDocBackupWorker extends ZcaDocSwingWorker implements IZcaDocBackupWorker {
    ...
    private void prepareZcaDocTaskBeforeBackup(ZcaDocTask aZcaDocTask) {
        /**
         * Update next time-point for execution before the lengthy task
         */
