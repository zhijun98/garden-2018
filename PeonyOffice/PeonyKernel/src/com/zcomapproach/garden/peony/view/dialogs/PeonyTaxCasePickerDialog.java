...
import com.zcomapproach.garden.peony.view.controllers.PeonyTaxCasePickerController;
 ...
 * @author zhijun98
 */
public class PeonyTaxCasePickerDialog extends PeonyFaceDialog{

    public PeonyTaxCasePickerDialog(Frame parent, boolean modal) {
        super(parent, modal);
    }
    ...
    protected PeonyFaceController createPeonyFaceController() {
        if (getPeonyFaceController() == null){
            PeonyTaxCasePickerController aPeonyFaceController = new PeonyTaxCasePickerController();
            /**
