 ...
 * @author zhijun98
 */
public class PeonyAccountEvent extends PeonyFaceEvent {
    /**
     * Every customer has a formal web account. Some legacy data may have fake account.
     */
    private final PeonyAccount customer;

    public PeonyAccountEvent(PeonyAccount customer) {
        this.customer = customer;
    }

    public PeonyAccount getCustomer() {
        return customer;
    }
