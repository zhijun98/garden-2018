...
import com.zcomapproach.garden.peony.taxpayer.controllers.TaxpayerTlcDriverController;
 ...
 * @author zhijun98
 */
public class TaxpayerTlcDriverDialog extends PeonyFaceDialog{

    private PeonyTaxpayerCase targetPeonyTaxpayerCase;
    private G02TlcLicense targetTlcLicense;
    /**
    ...
    public TaxpayerTlcDriverDialog(Frame parent, boolean modal) {
        super(parent, modal);
    }
    ...
    public void initializeTaxpayerTlcDriverDialog(final String dialogTitle, PeonyTaxpayerCase targetPeonyTaxpayerCase,
                                                  final G02TlcLicense targetTlcLicense,
    ...
    protected PeonyFaceController createPeonyFaceController() {
        if (getPeonyFaceController() == null){
            TaxpayerTlcDriverController aPeonyFaceController =  new TaxpayerTlcDriverController(targetTlcLicense, targetPeonyTaxpayerCase, true, false, true, null);
