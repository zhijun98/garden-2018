 ...
 * @author zhijun98
 */
public class TaxpayerInfoContactChanged extends PeonyFaceEvent{
    private final G02TaxpayerInfo targetTaxpayerInfo;

    public TaxpayerInfoContactChanged(G02TaxpayerInfo targetTaxpayerInfo) {
        this.targetTaxpayerInfo = targetTaxpayerInfo;
    }

    public G02TaxpayerInfo getTargetTaxpayerInfo() {
