...
import com.zcomapproach.garden.peony.taxpayer.controllers.TaxpayerCaseExportForPrintController;
 ...
 * @author zhijun98
 */
public class TaxpayerCaseExportForPrintDialog extends PeonyFaceDialog{
    
    private PeonyTaxpayerCase targetTaxpayerCase;

    public TaxpayerCaseExportForPrintDialog(Frame parent, boolean modal) {
        super(parent, modal);
    }
    ...
    protected PeonyFaceController createPeonyFaceController() {
        if (getPeonyFaceController() == null){
            TaxpayerCaseExportForPrintController aPeonyFaceController =  new TaxpayerCaseExportForPrintController(targetTaxpayerCase);
    ...
    public void launchTaxpayerCaseExportForPrintDialog(final String dialogTitle, final PeonyTaxpayerCase targetTaxpayerCase)
    {
