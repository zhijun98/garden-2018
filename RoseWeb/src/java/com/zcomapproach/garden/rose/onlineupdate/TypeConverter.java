...
import com.zcomapproach.garden.deprecated.WorkTarget;
...
public class TypeConverter {
    ...
    public static GardenEntityType convertWorkTargetToGardenEntityType(String value){
        WorkTarget aWorkTarget = WorkTarget.convertStringToType(value);
        switch(aWorkTarget){
            case INCORPORATION:
            case TAXCORP:
